...
const note tune0[] PROGMEM = {{1, TONE_LENGTH / 2}, {NOTE_F4, TONE_LENGTH / 2}, {NOTE_C5, TONE_LENGTH / 2}, {NOTE_F4, TONE_LENGTH / 2}, {NOTE_C5, TONE_LENGTH / 2}, {NOTE_DS5, TONE_LENGTH / 2}, {1, TONE_LENGTH / 2}, {NOTE_DS4, TONE_LENGTH / 2}, {1, TONE_LENGTH / 2}, {NOTE_DS4, TONE_LENGTH / 2}, {NOTE_GS4, TONE_LENGTH / 2}, {NOTE_DS4, TONE_LENGTH / 2}, {NOTE_GS4, TONE_LENGTH / 2}, {1, TONE_LENGTH / 2}, {NOTE_GS4, TONE_LENGTH / 2}, {NOTE_G4, TONE_LENGTH / 2}, {0, TONE_LENGTH}};
// 2ND_PM
const note tune1[] PROGMEM = {{NOTE_AS4, TONE_LENGTH / 8}, {1, TONE_LENGTH / 8}, {NOTE_AS5, TONE_LENGTH / 8}, {NOTE_F5, TONE_LENGTH / 8}, {NOTE_AS5, TONE_LENGTH / 8}, {NOTE_FS5, TONE_LENGTH / 8}, {NOTE_AS4, TONE_LENGTH / 8}, {1, TONE_LENGTH / 8}, {NOTE_AS5, TONE_LENGTH / 8}, {NOTE_F5, TONE_LENGTH / 8}, {NOTE_AS5, TONE_LENGTH / 8}, {NOTE_FS5, TONE_LENGTH / 8}, {NOTE_CS5, TONE_LENGTH / 8}, {1, TONE_LENGTH / 8}, {NOTE_GS4, TONE_LENGTH / 4}, {0, TONE_LENGTH}};
// Pile
const note tune2[] PROGMEM = {{NOTE_B4, TONE_LENGTH * 3 / 4}, {NOTE_B4, TONE_LENGTH * 3 / 4}, {NOTE_G4, TONE_LENGTH * 3 / 4}, {NOTE_G4, TONE_LENGTH * 3 / 4}, {NOTE_G4, TONE_LENGTH}, {NOTE_B4, TONE_LENGTH * 3 / 4}, {NOTE_B4, TONE_LENGTH * 3 / 4}, {NOTE_G4, TONE_LENGTH * 3 / 4}, {NOTE_G4, TONE_LENGTH * 3 / 4}, {NOTE_G4, TONE_LENGTH}, {NOTE_D5, TONE_LENGTH * 3 / 4}, {NOTE_D5, TONE_LENGTH * 3 / 4}, {NOTE_C5, TONE_LENGTH * 3 / 4}, {NOTE_C5, TONE_LENGTH * 3 / 4}, {NOTE_C5, TONE_LENGTH}, {NOTE_D5, TONE_LENGTH * 3 / 4}, {NOTE_D5, TONE_LENGTH * 3 / 4}, {NOTE_C5, TONE_LENGTH * 3 / 4}, {NOTE_C5, TONE_LENGTH * 3 / 4}, {NOTE_C5, TONE_LENGTH}, {0, TONE_LENGTH}};
// Monk
const note tune3[] PROGMEM = {{NOTE_AS4, TONE_LENGTH}, {NOTE_AS5, TONE_LENGTH}, {NOTE_AS4, TONE_LENGTH}, {1, TONE_LENGTH}, {NOTE_F5, TONE_LENGTH}, {1, TONE_LENGTH}, {NOTE_AS4, TONE_LENGTH}, {1, TONE_LENGTH}, {NOTE_CS5, TONE_LENGTH}, {1, TONE_LENGTH}, {NOTE_DS5, TONE_LENGTH}, {NOTE_F5, TONE_LENGTH}, {0, TONE_LENGTH}};
//Median
const note tune4[] PROGMEM = {{NOTE_FS4, TONE_LENGTH}, {NOTE_CS4, TONE_LENGTH}, {NOTE_D4, TONE_LENGTH * 2}, {NOTE_D4, TONE_LENGTH}, {NOTE_B3, TONE_LENGTH}, {NOTE_FS4, TONE_LENGTH * 2}, {0, TONE_LENGTH}};
//Bad Apple
const note tune5[] PROGMEM = {{NOTE_DS4, TONE_LENGTH}, {NOTE_F4, TONE_LENGTH}, {NOTE_FS4, TONE_LENGTH}, {NOTE_GS4, TONE_LENGTH}, {NOTE_AS4, TONE_LENGTH * 2}, {NOTE_DS5, TONE_LENGTH}, {NOTE_CS5, TONE_LENGTH}, {NOTE_AS4, TONE_LENGTH * 2}, {NOTE_DS4, TONE_LENGTH * 2}, {NOTE_AS4, TONE_LENGTH}, {NOTE_GS4, TONE_LENGTH}, {NOTE_FS4, TONE_LENGTH}, {NOTE_F4, TONE_LENGTH}, {NOTE_DS4, TONE_LENGTH}, {NOTE_F4, TONE_LENGTH}, {NOTE_FS4, TONE_LENGTH}, {NOTE_GS4, TONE_LENGTH}, {NOTE_AS4, TONE_LENGTH * 2}, {0, TONE_LENGTH}};
//Deadlock
const note tune6[] PROGMEM = {{NOTE_DS5, TONE_LENGTH * 5}, {NOTE_AS4, TONE_LENGTH}, {NOTE_F5, TONE_LENGTH}, {NOTE_DS5, TONE_LENGTH / 2}, {NOTE_AS5, TONE_LENGTH * 11 / 2}, {NOTE_G5, TONE_LENGTH}, {NOTE_F5, TONE_LENGTH}, {NOTE_DS5, TONE_LENGTH / 2}, {NOTE_F5, TONE_LENGTH * 11 / 2}, {0, TONE_LENGTH}};
//Elysium
const note tune7[] PROGMEM = {{NOTE_C5, TONE_LENGTH}, {NOTE_C5, TONE_LENGTH}, {1, TONE_LENGTH}, {NOTE_G4, TONE_LENGTH}, {NOTE_C5, TONE_LENGTH}, {1, TONE_LENGTH}, {NOTE_G4, TONE_LENGTH}, {NOTE_AS4, TONE_LENGTH}, {1, TONE_LENGTH}, {NOTE_G4, TONE_LENGTH}, {NOTE_F4, TONE_LENGTH}, {NOTE_G4, TONE_LENGTH}, {NOTE_F4, TONE_LENGTH}, {NOTE_DS4, TONE_LENGTH}, {NOTE_C4, TONE_LENGTH * 2}, {0, TONE_LENGTH}};
//Bad Apple 2
const note tune8[] PROGMEM = {{NOTE_DS4, TONE_LENGTH}, {NOTE_F4, TONE_LENGTH}, {NOTE_FS4, TONE_LENGTH}, {NOTE_GS4, TONE_LENGTH}, {NOTE_AS4, TONE_LENGTH * 2}, {NOTE_DS5, TONE_LENGTH}, {NOTE_CS5, TONE_LENGTH}, {NOTE_AS4, TONE_LENGTH * 2}, {NOTE_DS4, TONE_LENGTH * 2}, {NOTE_AS4, TONE_LENGTH}, {NOTE_GS4, TONE_LENGTH}, {NOTE_FS4, TONE_LENGTH}, {NOTE_F4, TONE_LENGTH}, {NOTE_DS4, TONE_LENGTH}, {NOTE_F4, TONE_LENGTH}, {NOTE_FS4, TONE_LENGTH}, {NOTE_GS4, TONE_LENGTH}, {NOTE_AS4, TONE_LENGTH * 2}, {NOTE_GS4, TONE_LENGTH}, {NOTE_FS4, TONE_LENGTH}, {NOTE_F4, TONE_LENGTH}, {NOTE_DS4, TONE_LENGTH}, {NOTE_F4, TONE_LENGTH}, {NOTE_FS4, TONE_LENGTH}, {NOTE_F4, TONE_LENGTH}, {NOTE_DS4, TONE_LENGTH}, {NOTE_D4, TONE_LENGTH}, {NOTE_F4, TONE_LENGTH}, {NOTE_DS4, TONE_LENGTH}, {NOTE_F4, TONE_LENGTH}, {NOTE_FS4, TONE_LENGTH}, {NOTE_GS4, TONE_LENGTH}, {NOTE_AS4, TONE_LENGTH * 2}, {NOTE_DS5, TONE_LENGTH}, {NOTE_CS5, TONE_LENGTH}, {NOTE_AS4, TONE_LENGTH * 2}, {NOTE_DS4, TONE_LENGTH * 2}, {NOTE_AS4, TONE_LENGTH}, {NOTE_GS4, TONE_LENGTH}, {NOTE_FS4, TONE_LENGTH}, {NOTE_F4, TONE_LENGTH}, {NOTE_DS4, TONE_LENGTH}, {NOTE_F4, TONE_LENGTH}, {NOTE_FS4, TONE_LENGTH}, {NOTE_GS4, TONE_LENGTH}, {NOTE_AS4, TONE_LENGTH * 2}, {NOTE_GS4, TONE_LENGTH}, {NOTE_FS4, TONE_LENGTH}, {NOTE_F4, TONE_LENGTH * 2}, {NOTE_FS4, TONE_LENGTH * 2}, {NOTE_GS4, TONE_LENGTH * 2}, {NOTE_AS4, TONE_LENGTH * 2}, {0, TONE_LENGTH}};

#else
uint16_t bpms[9] = {150, 150, 150, 150, 150, 150, 150 ,150, 150};

const note tune0[] PROGMEM = {{NOTE_C4, TONE_LENGTH}, {NOTE_C4, TONE_LENGTH}, {NOTE_G4, TONE_LENGTH}, {NOTE_G4, TONE_LENGTH}, {NOTE_A4, TONE_LENGTH}, {NOTE_A4, TONE_LENGTH}, {NOTE_G4, TONE_LENGTH * 2}, {0, TONE_LENGTH}};
const note tune1[] PROGMEM = {{NOTE_C4, TONE_LENGTH}, {NOTE_E4, TONE_LENGTH}, {NOTE_C4, TONE_LENGTH}, {NOTE_E4, TONE_LENGTH}, {NOTE_G4, TONE_LENGTH * 2}, {NOTE_G4, TONE_LENGTH * 2}, {0, TONE_LENGTH}};
const note tune2[] PROGMEM = {{NOTE_E4, TONE_LENGTH}, {NOTE_E4, TONE_LENGTH}, {NOTE_F4, TONE_LENGTH}, {NOTE_G4, TONE_LENGTH}, {NOTE_G4, TONE_LENGTH}, {NOTE_F4, TONE_LENGTH}, {NOTE_E4, TONE_LENGTH}, {NOTE_D4, TONE_LENGTH}, {NOTE_C4, TONE_LENGTH}, {NOTE_C4, TONE_LENGTH}, {NOTE_D4, TONE_LENGTH}, {NOTE_E4, TONE_LENGTH}, {NOTE_E4, TONE_LENGTH * 3 / 2}, {NOTE_D4, TONE_LENGTH / 2}, {NOTE_D4, TONE_LENGTH * 2}, {0, TONE_LENGTH}};
const note tune3[] PROGMEM = {{NOTE_G4, TONE_LENGTH}, {NOTE_G4, TONE_LENGTH / 2}, {NOTE_FS4, TONE_LENGTH / 2}, {NOTE_G4, TONE_LENGTH}, {NOTE_D4, TONE_LENGTH}, {0, TONE_LENGTH}};
const note tune4[] PROGMEM = {{NOTE_C4, TONE_LENGTH}, {NOTE_D4, TONE_LENGTH}, {NOTE_E4, TONE_LENGTH}, {NOTE_E4, TONE_LENGTH}, {NOTE_D4, TONE_LENGTH}, {NOTE_D4, TONE_LENGTH / 2}, {NOTE_E4, TONE_LENGTH / 2}, {NOTE_C4, TONE_LENGTH}, {NOTE_D4, TONE_LENGTH}, {0, TONE_LENGTH}};
const note tune5[] PROGMEM = {{NOTE_G4, TONE_LENGTH}, {NOTE_G4, TONE_LENGTH}, {NOTE_G4, TONE_LENGTH}, {NOTE_A4, TONE_LENGTH}, {NOTE_G4, TONE_LENGTH * 2}, {0, TONE_LENGTH}};
const note tune6[] PROGMEM = {{NOTE_C4, TONE_LENGTH}, {NOTE_C4, TONE_LENGTH}, {NOTE_E4, TONE_LENGTH}, {NOTE_C4, TONE_LENGTH}, {NOTE_G4, TONE_LENGTH}, {NOTE_G4, TONE_LENGTH}, {NOTE_A4, TONE_LENGTH}, {NOTE_G4, TONE_LENGTH}, {NOTE_F4, TONE_LENGTH}, {NOTE_E4, TONE_LENGTH}, {NOTE_D4, TONE_LENGTH * 2}, {NOTE_C4, TONE_LENGTH * 2}, {0, TONE_LENGTH}};
const note tune7[] PROGMEM = {{NOTE_A4, TONE_LENGTH}, {NOTE_A4, TONE_LENGTH}, {NOTE_G4, TONE_LENGTH}, {NOTE_E4, TONE_LENGTH}, {NOTE_A4, TONE_LENGTH}, {NOTE_A4, TONE_LENGTH}, {NOTE_G4, TONE_LENGTH * 2}, {0, TONE_LENGTH}};
const note tune8[] PROGMEM = {{NOTE_C4, TONE_LENGTH}, {NOTE_E4, TONE_LENGTH}, {NOTE_C4, TONE_LENGTH}, {NOTE_E4, TONE_LENGTH}, {NOTE_G4, TONE_LENGTH * 2}, {NOTE_G4, TONE_LENGTH * 2}, {NOTE_C4, TONE_LENGTH}, {NOTE_E4, TONE_LENGTH}, {NOTE_C4, TONE_LENGTH}, {NOTE_E4, TONE_LENGTH}, {NOTE_G4, TONE_LENGTH * 2}, {NOTE_G4, TONE_LENGTH * 2}, {NOTE_C5, TONE_LENGTH}, {NOTE_B4, TONE_LENGTH}, {NOTE_A4, TONE_LENGTH}, {NOTE_G4, TONE_LENGTH}, {NOTE_F4, TONE_LENGTH * 2}, {NOTE_A4, TONE_LENGTH * 2}, {NOTE_G4, TONE_LENGTH}, {NOTE_F4, TONE_LENGTH}, {NOTE_E4, TONE_LENGTH}, {NOTE_D4, TONE_LENGTH}, {NOTE_C4, TONE_LENGTH * 2}, {NOTE_C4, TONE_LENGTH * 2}, {0, TONE_LENGTH}};

#endif

const note* tunes[9] =
{tune0, tune1, tune2, tune3, tune4, tune5, tune6, tune7, tune8};
...
void play_tune() {
    if (playing_tune) {
        ...
        if (time - last_tone_start > tone_length) {
            ...
            note t = get_note_from_flash(tunes[tune_nr], tune_position);
            tune_position++;
            if (t.freq == 0) {
                noTone(SND);
                playing_tune = false;
